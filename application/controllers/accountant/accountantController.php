...
class AccountantController extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config = array();
        $config["base_url"] = "/accountant/payments";
    ...
    public function deletePaymentRecord()
    {
        ...
        redirect('/accountant/payments', 'refresh'); //redirecting to dashboard
    }
    ...
    public function updatePaymentRecord()
    {
        ...
        $this->session->set_flashdata('notification','payment updated Successful');
        redirect('/accountant/payments', 'refresh'); //redirecting to dashboard
    }
    ...
    public function addPaymentRecord()
    {
        ...
        $this->session->set_flashdata('notification','payment added Successful');
        redirect('/accountant/payments', 'refresh'); //redirecting to dashboard
    }
    ...
    public function blockPlayerAccount()
    {
        ...
        $this->session->set_flashdata('block','account status changed');
        redirect('/accountant/payments', 'refresh'); //redirecting to dashboard
    }
    ...
    public function viewPlayers()
    {
        ...
        $config["base_url"] = "/accountant/players";
        $this->pagination->initialize($config);
        $this->load->model('AccountantModel');
