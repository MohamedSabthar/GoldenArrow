        									...
        									<div role="document" class="modal-dialog">
        										<div class="modal-content">
        											...
        											<div class="modal-body">
        												<form method="post" action="<?php echo site_url('AdminController/createPracticeSession') ?>">
        							...
        							<tbody>
										...
										foreach ($result as $row) { ?>
        									<tr>
        										...
        										<td>
        											<a href="<?php echo site_url('AdminController/editPracticeSession'); ?>/<?php echo $row->ps_id; ?>" data-toggle="modal" data-target="<?php echo "#exampleModal2" . $modal_count; ?>" class="btn btn-outline-info btn-sm">Edit</a> <a href="<?php echo site_url('AdminController/deletePracticeSession'); ?>/<?php echo $row->ps_id; ?>" class="btn btn-outline-info btn-sm">Delete </a>
        											...
        											<div class="modal fade" id="<?php echo "exampleModal2" . $modal_count; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        												<div class="modal-dialog" role="document">
        													<div class="modal-content">
        														...
        														<div class="modal-body">
        															<form method="post" action="<?php echo site_url('AdminController/updatePracticeSession') ?>/<?php echo $row->ps_id; ?>">
        																<div class="form-group">
        																	<label for="exampleInputEmail1">Session ID</label>
