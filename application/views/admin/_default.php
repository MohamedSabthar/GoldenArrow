                ...
                >
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      ...
                      <span class="text-gray">145,14 GB</span>
                    </div>
                  </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="chart-holder">
                      <canvas
                        id="lineChart1"
                        style="max-height: 14rem !important;"
                        class="w-100"
                      ></canvas>
                    </div>
                  </div>
                    ...
                    <div class="row align-items-center flex-row">
                      <div class="col-lg-5">
                        <h2 class="mb-0 d-flex align-items-center">
                          <span>86.4</span
                          ><span
                            class="dot bg-green d-inline-block ml-3"
                          ></span>
                        </h2>
                    ...
                    <div class="row align-items-center flex-row">
                      <div class="col-lg-5">
                        <h2 class="mb-0 d-flex align-items-center">
                          <span>1.724</span
                          ><span
                            class="dot bg-violet d-inline-block ml-3"
                          ></span>
                        </h2>
                        <span class="text-muted text-uppercase small"
                          >Server time</span
                    ...
                    >
                      <div class="left d-flex align-items-center">
                        ...
                        <div class="text">
                          <h6 class="mb-0 d-flex align-items-center">
                            <span>App Store.</span
                            ><span class="dot dot-sm ml-2 bg-green"></span>
                          </h6>
                      ...
                      <div class="left d-flex align-items-center">
                        ...
                        <div class="text">
                          <h6 class="mb-0 d-flex align-items-center">
                            ...
                            ><span class="dot dot-sm ml-2 bg-blue"></span>
                          </h6>
                      ...
                      <div class="left d-flex align-items-center">
                        ...
                        <div class="text">
                          <h6 class="mb-0 d-flex align-items-center">
                            ...
                            ><span class="dot dot-sm ml-2 bg-red"></span>
                          </h6>
                          <small class="text-gray">Software cost</small>
                        </div>
                      </div>
              ...
              <div class="col-lg-4">
                ...
                <div class="card px-5 py-4">
                  ...
                  <div class="chart-holder">
                    <canvas
                      id="lineChart3"
                      style="max-height: 7rem !important;"
                      class="w-100"
                    >
                    </canvas>
                  </div>
                  ...
                  <div class="row">
                    ...
                    >
                      <strong class="h5 mb-0"
                        >24<sup class="smaller text-gray font-weight-normal"
                          >Apr</sup
                        ></strong
                      ><img
              ...
              <div class="col-lg-12">
                ...
                >
                  <div class="row">
                    ...
                    >
                      <strong class="h5 mb-0"
                        >17<sup class="smaller text-gray font-weight-normal"
                          >Aug</sup
                        ></strong
                      ><img
              ...
              <div class="col-lg-12">
                ...
                >
                  <div class="row">
                    ...
                    >
                      <strong class="h5 mb-0"
                        >15<sup class="smaller text-gray font-weight-normal"
                          >Sep</sup
                        ></strong
                      ><img
