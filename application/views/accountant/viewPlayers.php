                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                <strong class="h5 mb-0"><sup class="smaller text-gray font-weight-normal">ID
                                                    </sup><?= $player->userId ?></strong><img src="/img/avatar-4.jpg" alt="..." style="max-width: 3rem" class="rounded-circle mx-3 my-2 my-lg-0">
                                            ...
                                            <div class="col-lg-9 d-flex align-items-center flex-column flex-lg-row text-center text-md-left ">
                                                ...
                                                <p class="mb-0 mt-3 mt-lg-0 mx-5">
                                                    <button type="button" data-toggle="modal" data-target="#addPayment" class="ml-3 btn btn-outline-success" onClick="setIdToAddPaymentModel('<?= $player->userId ?>')" style="font-size:0.7rem">
                                                        Add Payment
                                                    </button>
                                                </p>
                                            </div>
