<div class="page-holder w-100 d-flex flex-wrap">
    <div class="container-fluid px-xl-5">
                        ...
                        <div class="card-body">
                            <form class="form-inline" method="POST" action="/accountant/trainers">
                                <div class="form-group">
                                    ...
                                    <input id="trainerName" type="text" placeholder="Name" class="mr-3 form-control" name="trainerName">
                                </div>
                                <div class="form-group">
                                    <label for="trainerId" class="sr-only">Trainer ID</label>
                                    <input id="trainerId" type="text" placeholder="Trainer ID" class="mr-3 form-control" name="trainerId">
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                                <strong class="h5 mb-0"><sup class="smaller text-gray font-weight-normal">ID
                                                    </sup><?= $trainer->userId ?></strong><img src="/img/avatar-4.jpg" alt="..." style="max-width: 3rem" class="rounded-circle mx-3 my-2 my-lg-0">
                                            ...
                                            <div class="col-lg-9 d-flex align-items-center flex-column flex-lg-row text-center text-md-left ">
                                                ...
                                                <p class="mb-0 mt-3 mt-lg-0 mx-5">
                                                    <button type="button" data-toggle="modal" data-target="#history" class="ml-3 mb-1 btn btn-outline-secondary" onClick="viewHistory('<?= $trainer->userId ?>')" style="font-size:0.7rem">
                                                        View
                                                    </button>
                                                    <button type="button" data-toggle="modal" data-target="#addPayment" class="ml-3 btn btn-outline-success" onClick="setIdToAddPaymentModel('<?= $trainer->userId ?>')" style="font-size:0.7rem">
                                                        Pay Salary
                                                    </button>
                                                </p>
                                            </div>
        ...
        <!-- history model -->
        <div id="history" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" class="modal fade text-left" style="display: none;" aria-hidden="true">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/accountant/update">
                            ...
                            <div class="form-group">
                                <label>Ammount</label>
                                <input name="ammount" id="ammountUpdate" type="number" placeholder="Ammount" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Date</label>
